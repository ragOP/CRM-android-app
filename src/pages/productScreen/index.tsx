...
const ceraVeProduct = {
    ...
    shortDescription: 'Deep hydration, 24-hour moisture, and a healthy skin barrier',
    images: [
    ...
    faqs: [
      {
        ...
        answer: 'CeraVe Moisturizing Cream has been specifically designed for dry to very dry skin. However, its non-comedogenic and fragrance-free formulation makes it suitable for most skin types unless you have a specific sensitivity to any of its ingredients.',
      },
      {
        question: 'How long does the moisturizing effect last?',
        answer: 'The unique formulation with MVE technology ensures your skin stays hydrated for up to 24 hours, protecting it throughout the day and night.',
      },
    ],
  };
...
const index: React.FC = () => {
    return (
        <ScrollView>
            <CustomSearch />
            <ProductPage product={ceraVeProduct} similarProducts={similarProducts} />
